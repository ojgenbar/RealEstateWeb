...
dhtmlXFileUploader.prototype.html5.prototype = {
	...
	_initEngine: function() {
		...
		if (this._upload_dnd) {
			...
			this._titleText = "Drag-n-Drop files here or<br>click to select files for uploads.";

		} else {
			this._titleText = "Click to select files for uploads.";
		}
	},
...
dhtmlXFileUploader.prototype.html4.prototype = {
	...
	_initEngine: function() {
		...
		this._titleText = "Click button<br>to select files for uploads.";
	},
